...

                    {
                        reviews.map(review => <SwiperSlide key={review._id}>
                            <div className="mx-20 flex flex-col items-center my-5">
                                ...
                                <p className="lg:text-xl text-lg text-center font-inter">{review.details}</p>
                                <h3 className=" text-center lg:text-3xl text-2xl font-inter text-[#CD9003] font-medium my-3">{review.name}</h3>
                            </div>
