...
const Footer = () => {
    return (
        <div>
            <footer>
                <div className="flex">
                    <div className="bg-[#1F2937] text-center lg:p-32 w-1/2 p-3 text-white lg:w-[960px] lg:h-[400px]">
                        <h3 className="lg:text-[32px]">CONTACT US</h3>
                    ...
                    <div className="bg-[#111827] text-white text-center lg:p-32 w-1/2 p-3  lg:w-[960px] lg:h-[400px]">
                        <h3 className="lg:text-[32px]">FOLLOW US</h3>
                        <p className="lg:text-[20px] my-3">
                            Join us on social media
                        </p>
                        <div className="flex justify-center  gap-5 lg:gap-10">
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 35 35" fill="none">
                                <path d="M20.2103 35V19.036H25.5666L26.3702 12.8127H20.2103V8.84007C20.2103 7.03885 20.7085 5.81134 23.2943 5.81134L26.587 5.80998V0.243652C26.0176 0.169654 24.063 0 21.788 0C17.0374 0 13.7851 2.89969 13.7851 8.22372V12.8127H8.4126V19.036H13.7851V35H20.2103Z" fill="white" />
                            </svg>
